...
@genai_handler(id="google-gemini-1.5-flash", vendor="google", vendor_model='gemini-1.5-flash', accepted_mimes=["video","image","audio"])
...
@genai_handler(id="dummy", vendor="suppanut", vendor_model='promaster64', accepted_mimes=["video","image/png","audio"])
